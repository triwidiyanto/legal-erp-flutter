...
void setDarkModeSetting(BuildContext context, ThemeMode themeMode, dynamic MyApp) =>
...
String getCurrentRoute(BuildContext context, dynamic MyApp) =>
    context.mounted ? MyApp.of(context).getRoute() : '';
List<String> getCurrentRouteStack(BuildContext context, dynamic MyApp) =>
